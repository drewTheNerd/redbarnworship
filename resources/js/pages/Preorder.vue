...
<template>
    ...
    <div class="relative min-h-dvh">
        ...
        <main class="relative z-10">
            <section class="max-w-md mx-auto p-2 pt-8">
                <div class=" w-full flex">
                    ...
                    <div class="w-2/3">
                        <div class="w-full text-black text-left pl-6 pt-4">
                            <h1 class="text-2xl font-helvetica font-black opacity-0 animate-fade-in delay-300">
                                At The Arena (Live) Album Preorder
                            </h1>
                            <p class="text-md font-helvetica font-regular opacity-0 animate-fade-in delay-300">
                                asdf
                            </p>
                        </div>
                    </div>
                ...
                <div class="w-full text-black text-center">
                    ...
                    <p class="text-lg font-helvetica font-regular opacity-0 animate-fade-in delay-300">
                        Live worship album now available!
                    </p>
                </div>
                ...
                <div class="w-full text-black text-center px-12 mt-4 space-y-3">
                    ...
                    >
                        ...
                        <span class="w-36 group-hover:text-black transition">Spotify</span>
                    </a>
